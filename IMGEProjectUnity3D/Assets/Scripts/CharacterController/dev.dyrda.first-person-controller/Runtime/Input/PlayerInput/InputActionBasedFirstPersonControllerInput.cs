...
public class InputActionBasedFirstPersonControllerInput : FirstPersonControllerInput
{
    ...
    public override IObservable<Unit> Escape => _escape;
    private Subject<Unit> _escape;
    ...
    protected void Awake()
    {
        ...
        _escape = new Subject<Unit>().AddTo(this);
        _controls.Character.Escape.performed += context => _escape.OnNext(Unit.Default);
